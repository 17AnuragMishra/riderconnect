...
const GroupsPage = () => {
    ...
    const initializePage = async () => {
      try {
        ...
        if (groups.size == 0) {
          ...
          // Ensure groups data is properly handled
  ...
  }, [user, isLoaded, groups, router, toast]);
              ...
              <CardContent>
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Connected rides</p>
                  </div>
                </div>
              </CardContent>
            </StatsCard>
              ...
              <CardContent>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold">
                        {groups.length > 0 ? 
                        Math.max(...groups.map((g: Group) => getGroupMetrics(g.source, g.destination).distance)) : 0} km
                    </div>
            ...
            <StatsCard>
              ...
              <CardContent>
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="text-2xl font-bold">
                        {groups.reduce((total: number, group: Group) => total + group.members.length, 0)}
                    </div>
