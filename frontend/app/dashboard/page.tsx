      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-foreground">
            Create or join groups to track locations and stay connected
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Dialog open={createDialogOpen} onOpenChange={setCreateDialogOpen}>
            <DialogTrigger asChild>
              <Card className="border-dashed cursor-pointer hover:border-primary/50 transition-colors p-6 text-center">
            ...
            <DialogContent>
              ...
              <Button onClick={openSourceToDestModal}>Next Step</Button>
            </DialogContent>
          </Dialog>
          ...
          <Dialog open={showRouteModal} onOpenChange={setShowRouteModal}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Enter the Source and Destination of the ride.
                </DialogDescription>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                ...
                <Input
                  id="destination"
                  placeholder="eg: Ladakh"
                  value={destination}
                  onChange={(e) => setDestination(e.target.value)}
                />
              </div>
              <Button onClick={() => console.log("Ride Created")}>
                Create Ride
              </Button>
            </DialogContent>
          </Dialog>
